...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    activity: "Tarayıcı yerel araç etkinliği özetleri.",
  ...
  activity: {
    ...
    argumentHiddenOne: "1 argüman gizlendi",
    argumentsHidden: "{count} argüman gizlendi",
    streamLabel: "Araç etkinliği girişleri",
    toolCallId: "Araç çağrısı",
    runId: "Çalıştır",
    session: "Oturum",
    outputTruncated: "Önizleme redakte edildi ve kısaltıldı.",
