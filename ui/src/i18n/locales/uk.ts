...
export const uk: TranslationMap = {
  ...
  subtitles: {
    ...
    activity: "Локальні для браузера зведення активності інструментів.",
  ...
  activity: {
    title: "Активність",
    subtitle: "Тимчасова активність інструментів, отримана з подій живого сеансу.",
    visibleCount: "{visible} з {total}",
    filtersLabel: "Фільтри активності",
    search: "Пошук",
    searchPlaceholder: "Фільтрувати за інструментом, зведенням, запуском, сеансом",
    toolFilter: "Інструмент",
    allTools: "Усі інструменти",
    statusFilters: "Фільтри статусу",
    autoFollow: "Автослідування",
    ...
    runId: "Запустити",
    session: "Сеанс",
    outputTruncated: "Попередній перегляд відредаговано й скорочено.",
